        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-8 text-lg leading-relaxed text-muted-foreground text-center">
            ...
            <div className="pt-8 border-t border-border">
              ...
              <p className="mt-4 text-lg">"We wilden één simpel product dat dit oplost zonder verbouwing, zonder gedoe, en zonder felle lichten. Alleen een warme, veilige glow die reageert op jouw beweging."</p>
            </div>
          </div>

          <div className="mt-16 flex justify-center">
            <div className="rounded-3xl overflow-hidden shadow-2xl max-w-md">
              <img src={storytellingImage} alt="SenseGlow LED strip die warm oplicht in het donker" className="w-full h-auto" />
            </div>
          </div>
        </div>
      </div>
