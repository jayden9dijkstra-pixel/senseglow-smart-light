...
const defaultOutcomes = [
  { icon: "🌙", title: "Rustige nachtelijke bewegingen", description: "Geen felle lampen meer. Geen slaapinterrupties." },
  { icon: "🛡️", title: "Veiligheid in donkere ruimtes", description: "Trap & gang zichtbaar zonder fel licht." },
  { icon: "👶", title: "Kinderen die zelf durven", description: "Een warme glow geeft vertrouwen." },
];

export const OutcomeSection = ({ 
  headline = "Je koopt geen lamp. je koopt veiligheid in het donker.",
