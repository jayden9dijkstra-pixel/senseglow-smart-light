      ...
      <div className="container">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground">Je koopt geen lamp. je koopt veiligheid in het donker.</h2>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {outcomes.map((outcome, index) => <Card key={index} className="p-8 bg-muted/50 border-border hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
