...
export const ROUTE_SEO: Record<string, SeoEntry> = {
  ...
  "/verzending": {
    ...
    description:
      "Alles over onze verzending: gratis bezorging in Nederland en België, verzending binnen 7 tot 14 dagen na verwerking en track & trace. Bekijk de voorwaarden.",
  },
  "/bestelling-volgen": {
